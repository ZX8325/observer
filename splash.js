...
(function (root, factory) {
  ...
  /* ─────────────────────────────────────────────────────────────
     文案（★ 2026-09-21 给的原文，一个字没动）
     ⚠️ 每行末尾是 ASCII 的三个点 `...`，不是中文省略号「…」——
        就是这么写的，而且这是**终端口吻**的屏幕，三个点更对味。
  ...
  function begin() {
    ...
    /* ① 整屏淡出 —— 黑色背景 + 四行字 + 提示行 **一起**淡。
       ★ 2026-09-21 第 3 版：把光刃和白球整个撤掉，只留这一层。
         原话「严格执行'全局淡出'」「像雾气消散」。
